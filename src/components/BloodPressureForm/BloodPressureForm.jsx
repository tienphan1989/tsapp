...
export default class BloodPressureForm extends Component {
  ...
  handleSubmit = () => {
    ...
    fetch(
      "http://localhost:3000/api/v1/bpscreen",
      configObj("POST", true, {
        bp: {
            ...
            <form onSubmit={this.handleClickOpen}>
              ...
              {!localStorage.token && (
                <FormControl
                  ...
                  focused="true"
                >
                  <label htmlFor="age" className="age-value">
                    Age:{" "}
                  </label>
                  <TextField
                    label="age"
              ...
              <div className="bp-intake-boxes">
                <FormControl
                  ...
                  size="small"
                >
                  <label htmlFor="systolic_pressure" className="bp-intake-boxes">
                    Systolic Pressure:{" "}
                  </label>
                  <TextField
                    label="..."
              ...
              <div className="bp-intake-boxes">
                <FormControl
                  ...
                  size="small"
                >
                  <label htmlFor="diastolic_pressure" className="bp-intake-boxes">
                    Diastolic Pressure:{" "}
                  </label>
                  <TextField
                    label="..."
              ...
              <div className="pressure-submit-button">
                <Button
                  variant="contained"
                  color="secondary"
                  type="submit"
